...
public class login extends javax.swing.JFrame {
    ...
    public Statement st;
    public ResultSet rs;
    public Connection kon = latihan.konekdb.bukaKon();
    public login() {
        initComponents();
    }
    ...
    private void BtnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLoginActionPerformed
        ...
        try {
           ...
           String cekQuery = "SELECT * FROM tabel_login WHERE username = '" + txtUsername.getText() + "' AND password = '" + txtpassword.getText() + "'";
            rs = st.executeQuery(cekQuery);
            if (rs.next()){
                main mainFrame = new main(); // Ganti dengan kelas halaman utama Anda
